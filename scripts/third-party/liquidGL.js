 ...
 * Licence: MIT
 * Version: v2.0.1
 * Local modification: adds the edgeOnly option used to confine rendering to
 * the existing bevel band. See scripts/README.md for integration details.
 */
  ...
  class liquidGLRenderer {
    ...
    _initGL() {
      ...
      this.u = {
        ...
        edgeOnly: gl.getUniformLocation(this.program, "u_edgeOnly"),
    ...
    _renderLens(lens) {
      ...
      gl.uniform1i(this.u.edgeOnly, lens.options.edgeOnly ? 1 : 0);

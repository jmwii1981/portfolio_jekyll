...
(async () => {
    ...
    const expectedRecordIds = [
        ...
        'section:/terms/#ownership-of-site-materials',
        'section:/terms/#professional-work-and-contributions',
        'section:/terms/#third-party-names-marks-and-materials',
        'section:/terms/#portfolio-confidentiality-and-representative-material',
        'section:/terms/#testimonials-and-professional-statements',
        'section:/terms/#rights-and-confidentiality-requests',

        ...
        <div class="work-items-wrapper">
            <article class="project-story" aria-labelledby="lmms-title">
                ...
                <div class="project-walkthrough" data-project-gallery data-reveal="up">
                    <header class="project-walkthrough-header">
                        <p class="p project-walkthrough-label">Inside the experience</p>
                        <div class="project-gallery-controls">
                            <button class="project-gallery-button" type="button" data-gallery-previous aria-label="View previous LionFinancial screen">←</button>
                            <p class="p project-gallery-count" aria-live="polite"><span data-gallery-current>1</span> / 6</p>
                            <button class="project-gallery-button" type="button" data-gallery-next aria-label="View next LionFinancial screen">→</button>
                        </div>
                    </header>
            ...
            <article class="project-story" aria-labelledby="vega-title">
                <header class="project-story-header project-story-header--right" data-reveal="up">
                    ...
                    <a class="a project-story-link" href="https://vega.globalpayments.com/" target="_blank" rel="noopener noreferrer">Visit Vega <span aria-hidden="true">↗</span></a>
                </header>
                ...
                <div class="project-walkthrough" data-project-gallery data-reveal="up">
                    <header class="project-walkthrough-header">
                        <p class="p project-walkthrough-label">Inside the system</p>
                        <div class="project-gallery-controls">
                            <button class="project-gallery-button" type="button" data-gallery-previous aria-label="View previous Vega screen">←</button>
                            <p class="p project-gallery-count" aria-live="polite"><span data-gallery-current>1</span> / 6</p>
                            <button class="project-gallery-button" type="button" data-gallery-next aria-label="View next Vega screen">→</button>
                        </div>
                    </header>
            ...
            <article class="project-story" aria-labelledby="avena-title">
                ...
                <div class="project-walkthrough" data-project-gallery data-reveal="up">
                    <header class="project-walkthrough-header">
                        <p class="p project-walkthrough-label">Inside the experience</p>
                        <div class="project-gallery-controls">
                            <button class="project-gallery-button" type="button" data-gallery-previous aria-label="View previous AvenaPay screen">←</button>
                            <p class="p project-gallery-count" aria-live="polite"><span data-gallery-current>1</span> / 6</p>
                            <button class="project-gallery-button" type="button" data-gallery-next aria-label="View next AvenaPay screen">→</button>
                        </div>
                    </header>
                    <div class="project-gallery-viewport" data-gallery-viewport tabindex="0" aria-label="AvenaPay product walkthrough">
                        <div class="project-gallery-track">
                            <figure class="project-screen" data-gallery-slide>
                                <div class="project-screen-image"><img src="{{ '/images/projects/avena/Dashboard - Outcomes.png' | relative_url }}" alt="AvenaPay outcomes dashboard with case metrics and trend visualization" loading="lazy" decoding="async"></div>
                            ...
                            <figure class="project-screen" data-gallery-slide>
                                <div class="project-screen-image"><img src="{{ '/images/projects/avena/Dashboard - Volume.png' | relative_url }}" alt="AvenaPay dispute volume dashboard" loading="lazy" decoding="async"></div>
                            ...
                            <figure class="project-screen" data-gallery-slide>
                                <div class="project-screen-image"><img src="{{ '/images/projects/avena/My Cases _ Case Details.png' | relative_url }}" alt="AvenaPay case detail workflow" loading="lazy" decoding="async"></div>
                            ...
                            <figure class="project-screen" data-gallery-slide>
                                <div class="project-screen-image"><img src="{{ '/images/projects/avena/Alerts and Notifications.png' | relative_url }}" alt="AvenaPay alerts and notifications interface" loading="lazy" decoding="async"></div>
                            ...
                            <figure class="project-screen" data-gallery-slide>
                                <div class="project-screen-image"><img src="{{ '/images/projects/avena/Reports _ Q2 Exec Overview.png' | relative_url }}" alt="AvenaPay executive disputes report" loading="lazy" decoding="async"></div>
                            ...
                            <figure class="project-screen" data-gallery-slide>
                                <div class="project-screen-image"><img src="{{ '/images/projects/avena/Ask AI.png' | relative_url }}" alt="AvenaPay AI-assisted case analysis interface" loading="lazy" decoding="async"></div>
            ...
            <article class="project-story" aria-labelledby="paladin-title">
                ...
                <div class="project-walkthrough" data-project-gallery data-reveal="up">
                    <header class="project-walkthrough-header">
                        <p class="p project-walkthrough-label">Inside the kit</p>
                        <div class="project-gallery-controls">
                            <button class="project-gallery-button" type="button" data-gallery-previous aria-label="View previous Paladin screen">←</button>
                            <p class="p project-gallery-count" aria-live="polite"><span data-gallery-current>1</span> / 6</p>
                            <button class="project-gallery-button" type="button" data-gallery-next aria-label="View next Paladin screen">→</button>
                        </div>
                    </header>
            ...
            <article class="project-story" aria-labelledby="ledger-title">
                ...
                <div class="project-walkthrough" data-project-gallery data-reveal="up">
                    <header class="project-walkthrough-header">
                        <p class="p project-walkthrough-label">Inside the experience</p>
                        <div class="project-gallery-controls">
                            <button class="project-gallery-button" type="button" data-gallery-previous aria-label="View previous LedgerFlow screen">←</button>
                            <p class="p project-gallery-count" aria-live="polite"><span data-gallery-current>1</span> / 6</p>
                            <button class="project-gallery-button" type="button" data-gallery-next aria-label="View next LedgerFlow screen">→</button>
                        </div>
                    </header>
            ...
            <article class="project-story" aria-labelledby="northstar-title">
                ...
                <div class="project-walkthrough" data-project-gallery data-reveal="up">
                    <header class="project-walkthrough-header">
                        <p class="p project-walkthrough-label">Through the conversion story</p>
                        <div class="project-gallery-controls">
                            <button class="project-gallery-button" type="button" data-gallery-previous aria-label="View previous Northstar screen">←</button>
                            <p class="p project-gallery-count" aria-live="polite"><span data-gallery-current>1</span> / 6</p>
                            <button class="project-gallery-button" type="button" data-gallery-next aria-label="View next Northstar screen">→</button>
                        </div>
                    </header>

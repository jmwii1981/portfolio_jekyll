...
<h2 class="h2 massive">Work</h2>
    <div class="work-items-wrapper">
        <section class="work-item">
            <a class="a item-wrapper" href="//www.figma.com/deck/UERQURaUcK0Lkq0kFNAgq3/Untitled?node-id=1-62&t=sTNvOLC5sVvb7jwf-1" aria-label="See more about Product X on Figma" target="_blank">
                ...
                <h2 class="h2 a project-name">Color Exploration {% include icon.html name="new-tab" %}</h2>
            </a>
        </section>
        <section class="work-item">
            <a class="a item-wrapper" href="//www.figma.com/deck/UERQURaUcK0Lkq0kFNAgq3/Untitled?node-id=1-62&t=sTNvOLC5sVvb7jwf-1" aria-label="See more about Product X on Figma" target="_blank">
    ...
    <section class="eop-cta">
        <a class="a" href="//www.figma.com/@jmwii1981" target="_blank">See more in Figma {% include icon.html name="new-tab" %}</a>
    </section>
</main>